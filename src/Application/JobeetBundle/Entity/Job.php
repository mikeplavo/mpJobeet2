...
/**
 * @orm:Entity(repositoryClass="Application\JobeetBundle\Entity\JobRepository")
 * @orm:Table(name="job")
 */
...
class Job
{
  ...
  /**
   * @orm:Column(type="string", length="255", name="logo")
   */
  protected $logo;
  ...
  /**
   * @orm:Column(type="string", length="255", unique=true, name="token")
   */
  protected $token;

  /**
   * @orm:Column(type="boolean", name="is_public", name="is_public")
   */
  protected $isPublic;
   ...
   * Set category
   *
   * @param Application\JobeetBundle\Entity\Category $category
   */
  public function setCategory(\Application\JobeetBundle\Entity\Category $category)
  {
   ...
   * Get category
   *
   * @return Application\JobeetBundle\Entity\Category $category
   */
