...
namespace Application\JobeetBundle\DataFixtures\ORM;

use Doctrine\Common\DataFixtures\FixtureInterface;
use Application\JobeetBundle\Entity\Job;
use Application\JobeetBundle\Entity\Category;
use Application\JobeetBundle\Entity\Post;
use Application\JobeetBundle\Entity\Tag;


class JobeetFixtureLoader  implements FixtureInterface
{
    public function load($manager)
    {
        ...
        for ($i = 100 ; $i <= 130 ; $i++)
        {
            ...
            $jobs[$i]->setExpiresAt(new \DateTime('2012-10-10'));
